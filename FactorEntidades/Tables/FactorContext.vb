...
Partial Public Class FactorContext
	...
	End Sub
	Public Overridable Property Acceso As DbSet(Of Acceso)
	...
	Public Overridable Property CtrlRiesgo As DbSet(Of Ctrlriesgo)
	Public Overridable Property Permiso As DbSet(Of Permiso)
	Public Overridable Property notifica_e As DbSet(Of notifica_e)
	Public Overridable Property parametros As DbSet(Of parametros)
	Public Overridable Property Aforo As DbSet(Of Aforo)
	Public Overridable Property reporte As DbSet(Of reporte)
	Public Overridable Property cfdicartera As DbSet(Of cfdicartera)
  Public Overridable Property version As DbSet(Of version)
  Public Overridable Property consolida As DbSet(Of consolida)
	...
	Protected Overrides Sub OnModelCreating(ByVal modelBuilder As DbModelBuilder)
		...
		modelBuilder.Entity(Of contratos)() _
		.Property(Function(e) e.rebatepts) _
		.HasPrecision(5, 2)
	...
	.IsUnicode(False)
		...
		modelBuilder.Entity(Of perfil)() _
		  .Property(Function(e) e.nombre) _
		  .IsFixedLength() _
		  .IsUnicode(False)
		...
		modelBuilder.Entity(Of Ctrlriesgo)() _
		   .Property(Function(e) e.Idlinea) _
		   .HasPrecision(8, 0)
		...
		modelBuilder.Entity(Of Permiso)() _
		   .Property(Function(e) e.descripcion) _
		   .IsFixedLength() _
		   .IsUnicode(False)

		modelBuilder.Entity(Of notifica_e)() _
		   .Property(Function(e) e.idrec) _
		   .HasPrecision(10, 0)

		modelBuilder.Entity(Of notifica_e)() _
		  .Property(Function(e) e.filename) _
		  .IsFixedLength() _
		  .IsUnicode(False)
		...
		modelBuilder.Entity(Of notifica_e)() _
		  .Property(Function(e) e.evidencia) _
		  .IsFixedLength() _
		  .IsUnicode(False)

		modelBuilder.Entity(Of parametros)() _
		  .Property(Function(e) e.clave) _
		  .IsFixedLength() _
		  .IsUnicode(False)

		modelBuilder.Entity(Of parametros)() _
		  .Property(Function(e) e.ruta) _
		  .IsUnicode(False)

		modelBuilder.Entity(Of Aforo)() _
		  .Property(Function(e) e.cobrado) _
		  .HasPrecision(14, 2)

		modelBuilder.Entity(Of Aforo)() _
		  .Property(Function(e) e.aforo1) _
		  .HasPrecision(14, 2)
		...
		modelBuilder.Entity(Of Aforo)() _
		  .Property(Function(e) e.pgeaforo) _
		  .HasPrecision(8, 2)

		modelBuilder.Entity(Of reporte)() _
			  .Property(Function(e) e.modulo) _
			  .IsFixedLength() _
			  .IsUnicode(False)
		...
		modelBuilder.Entity(Of reporte)() _
			.Property(Function(e) e.url) _
			.IsUnicode(False)

		modelBuilder.Entity(Of cfdicartera)() _
		   .Property(Function(e) e.pago) _
		   .HasPrecision(14, 2)
		...
		modelBuilder.Entity(Of version)() _
		.Property(Function(e) e.version1) _
		.IsUnicode(False)
    ...
    modelBuilder.Entity(Of consolida)() _
       .Property(Function(e) e.archivo) _
       .IsUnicode(False)

    modelBuilder.Entity(Of consolida)() _
        .Property(Function(e) e.resultado) _
        .IsUnicode(False)
