...
#Region "Parametros"
		...
		Function Parametros() As ViewResult
			...
			model.timecte = DateTime.Parse(parametro.timecte).ToString("HH:mm")
...
#Region "Post"
		...
		Public Function GuardarParametros(parametro As ParametrosModel) As ActionResult
			...
			If ModelState.IsValid Then
				...
				model.timecte = DateTime.Now.Date.Add(New TimeSpan(Convert.ToInt64(parametro.timecte.Split(":")(0)), Convert.ToInt64(parametro.timecte.Split(":")(1)), 0))
