...
var data =
{
    inicializarTabla: function (fechaMes, fechaAnio) {
        ...
        tabla = $('#table')
            .DataTable({
                ajax: {
                    "url": "../Catalogos/ObtenerListaSucursal/", // url del controlador a consultar 
                    "Type": "GET",
           ...
           { data: "nombre"},
           {
               data: "sucursal1", "width": "50px", "render": function (data) {
                   return '<a class="popup" href="../Catalogos/GuardarSucursal?suc=' + data + '" add="true" ><button type="button" class="btn glyphicon glyphicon-pencil"></button></a>';
               }, orderable: false
           }
                ],
                "columnDefs": [
    ...
    openPopUp: function (pageUrl) {
        ...
        $pageContent.load(pageUrl, function () {
            ...
            $pageContent.dialog({
                width: $(window).width() - 200 , // overcomes width:'auto' and maxWidth bug
