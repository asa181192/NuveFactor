...
#Region "Metodos de consulta"
    ...
    Public Function ConsultaAnexoCtoDAL(Contrato As Integer, ByRef lista As List(Of DropDownEntidad))
        ...
        Using context As New FactorContext
            Try
                ...
                If producto = 1 Then
                    ...
                    Where A.contrato = Contrato And A.cancelado = 0
                    ).ToList().Select(Function(x) New DropDownEntidad With {
                      .clave = x.A.deudor,
