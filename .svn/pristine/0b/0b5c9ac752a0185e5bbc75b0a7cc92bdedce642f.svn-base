...
@Section Scripts 
      <script src="/Scripts/CatalogosScripts/Comprador.js"></script>
End Section 
        ...
        <div class="topmargin" >
            <div class="form-inline">
                 <div class="form-group">                       
                      @Html.ActionLink("Nuevo Comprador", "GuardarComprador", New With {.deudor = 0},New With{.Class="popup btn bold"})                              
                 </div>
                 <div class="form-group">
                      @Code
    ...
    <div class="panel-body">
            <div class="jumbotron">     
                <div class="table-responsive">        
                    <table id="tableComprador"  class ="table cell-border compact hover" style="width:100%">
                       <thead>
                             <tr>
                                <th>
