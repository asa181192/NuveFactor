...
@section scripts
    <script src="~/Scripts/TesoScripts/movimientos.js?v=@String.Concat(Today.Day,Today.Month,Today.Year,TimeOfDay.Hour,TimeOfDay.Minute,TimeOfDay.Second)"></script>
End Section
            ...
            <div class="table-responsive">
                <table id="tableMovimientos" class="table cell-border compact hover" style="width: 100%">
                    ...
                    <tfoot>
                        <tr>                            
                            <th>Saldo incial:</th>
                            <th><span style="color:#3CD5D1" id="saldoInicial"></span></th>
                            <th>Saldo actual:</th>
                            <th><span id="saldoActual" style="color:#3CD5D1;"></span></th>
                            <th colspan="7"></th>
                        </tr>
                    </tfoot>
                </table>
