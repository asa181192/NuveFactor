...
var financiero =
{
    inicializarTabla: function (fechaMes, fechaAnio) {
        ...
        tablaFinanciero = $('#tableFinanciero')
           ...
           { data: "fecha" },
           { data: "cetes28", orderable: false },
           { data: "cetes91", orderable: false },
           { data: "cpp", orderable: false },
           { data: "tiie", orderable: false },
           { data: "tiie91", orderable: false },
           { data: "tiip", orderable: false },
           { data: "fondeo", orderable: false },
           { data: "libor", orderable: false },
           { data: "libor3m", orderable: false },
           { data: "libor6m", orderable: false },
           { data: "libor12m", orderable: false },
           { data: "fondeousd", orderable: false },
           {
