...
var data =
{
        ...
        tabla = $('#table')
           ...
           },
           {
               data: function (data, type, dataToSet) {
                   return '<a class="cancelar" href="../Cobranza/CancelarAforo?numrec=' + data.numrec + '" contrato="'+data.contrato+'"><button type="submit" class="btn glyphicon glyphicon-remove"></button></a>';
               }, "width": "50px"
           },
           {
               data: function (data, type, dataToSet) {
                ...
                "columnDefs": [
                    { "className": "dt-center", "targets": [0,3,4,5,6,7,8,9] } // permite centrar botones de edicion 
                ]
            });
    ...
    eventos: function () {   
        tabla.on('click', 'a.cancelar', function (e) {
            $('#dialog-confirm').text("Se cancelara el aforo , ¿Desea continuar?")
...
$(document).ready(function (e) {  
    $("#month").datepicker({
        ...
        onSelect: function (e, obj) {
            data.inicializarTabla(e, $("#contrato").val());
        }
    }).datepicker("setDate", new Date())
    data.inicializarTabla($("#month").val(), $("#contrato").val());
    data.eventos();
});