...
var data =
{
    inicializarTabla: function () {
        ...
        tabla = $('#table')
            .DataTable({
                ajax: {
                    "url": "../Catalogos/ObtenerListaCodigoGarantia/", // url del controlador a consultar 
                    "Type": "GET",
           ...
           { data: "cod_alterno" },
           {
               data: "codigoid", "width": "50px", "render": function (data) {
                   return '<a class="popup" href="../Catalogos/GuardarCodigoGarantia?codigoid=' + data + '" add="true" ><button type="button" class="btn glyphicon glyphicon-pencil"></button></a>';
               }, orderable: false
           }
                ],
                "columnDefs": [
