...
var data =
{
    inicializarTabla: function () {
        ...
        tabla = $('#table')
            .DataTable({
                ajax: {
                    "url": "../Admin/ObtenerListaTipoGarantia/", // url del controlador a consultar 
                    "Type": "GET",
           ...
           { data: "concepto" },
           {
               data: "tipoid", "width": "50px", "render": function (data) {
                   return '<a class="popup" href="../Admin/GuardarTipoGarantia?tipoid=' + data + '" add="true" ><button type="button" class="btn glyphicon glyphicon-pencil"></button></a>';
               }, orderable: false
           }
                ],
                "columnDefs": [
