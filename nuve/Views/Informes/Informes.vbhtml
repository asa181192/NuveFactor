...
@Section Scripts
  <script src="~/Scripts/InformesScripts/Informes.js?v=@String.Concat(Today.Day, Today.Month, Today.Year, TimeOfDay.Hour, TimeOfDay.Minute, TimeOfDay.Second)"></script>
End Section
