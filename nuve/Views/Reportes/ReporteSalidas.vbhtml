...
@section scripts
    <script src="~/Scripts/Reportes/Tesoreria/ReporteSalidas.js?v=@String.Concat(Today.Day, Today.Month, Today.Year, TimeOfDay.Hour, TimeOfDay.Minute, TimeOfDay.Second)"></script>
End Section
    ...
    <div class="panel-body">
        <div class="jumbotron">
            <div class="table-responsive">
                <table id="tableSalidas" class="table cell-border compact hover" style="width: 100%">
                    <thead>
                        <tr>
                            <th>
